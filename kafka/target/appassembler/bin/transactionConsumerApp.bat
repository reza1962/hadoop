...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="transactionConsumerApp" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.multilix.kafka.app.TransactionConsumerApp %CMD_LINE_ARGS%
